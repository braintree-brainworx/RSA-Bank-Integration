...
The methods of integration which are available vary between banks:

| Bank | CSVFNBort Payment | CSV Import Statement| Direct Export | Direct Import | DO export | DO Export |
|---|---|---|---|---|---|---|
|ABSA| Yes | Yes |  | | | |
